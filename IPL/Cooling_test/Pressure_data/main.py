...
# List of CSV files
csv_files = ['pressure_data_cooling_2bar.csv','pressure_data_cooling_(8bar).csv', 
             'pressure_data_cooling_3bar.csv', 'pressure_data_cooling_4bar.csv', 
             'pressure_data_cooling_5bar.csv', 'pressure_data_cooling_8bar.csv',
             'pressure_data_cooling_8bar(2).csv']
