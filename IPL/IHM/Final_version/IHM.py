...
"}")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.open_SV11.clicked.connect(self.SV111)
        self.closed_SV11.clicked.connect(self.SV110)

        self.open_SV12.clicked.connect(self.SV121)
        self.closed_SV12.clicked.connect(self.SV120)

        self.open_SV21.clicked.connect(self.SV211)
        self.closed_SV21.clicked.connect(self.SV210)
        
        self.open_SV22.clicked.connect(self.SV221)
        self.closed_SV22.clicked.connect(self.SV220)

        self.open_SV31.clicked.connect(self.SV311)
        self.closed_SV31.clicked.connect(self.SV310)
        
        self.open_SV32.clicked.connect(self.SV321)
        self.closed_SV32.clicked.connect(self.SV320)

        self.open_SV33.clicked.connect(self.SV331)
        self.closed_SV33.clicked.connect(self.SV330)

        self.open_SV34.clicked.connect(self.SV341)
        self.closed_SV34.clicked.connect(self.SV340)
        
        self.open_SV35.clicked.connect(self.SV351)
        self.closed_SV35.clicked.connect(self.SV350)

        self.open_SV51.clicked.connect(self.SV511)
        self.closed_SV51.clicked.connect(self.SV510)
        
        self.open_SV61.clicked.connect(self.SV611)
        self.closed_SV61.clicked.connect(self.SV610)

        self.open_SV62.clicked.connect(self.SV621)
        self.closed_SV62.clicked.connect(self.SV620)
    ...
    def SV111(self):
        ...
        client_socket.sendto(str.encode("SV111"), address)
        rec_data, addr = client_socket.recvfrom(1024)
        
        if rec_data==b'SV111_ok':
            _translate =  QCoreApplication.translate
            MainWindow.setWindowTitle(_translate("MainWindow", "MainWindow"))
            ...
            self.SV11.setGraphicsEffect(color_effect)

            self.label_SV11.setText(_translate("MainWindow", "Open"))
            color_effect = QGraphicsColorizeEffect() 
            color_effect.setColor(Qt.darkGreen) 
            self.label_SV11.setGraphicsEffect(color_effect)

    def SV110(self):
        address = ('192.168.0.101', 5000) #Defind who you are talking to (must match arduino IP and port)
        client_socket = socket(AF_INET, SOCK_DGRAM) #Set Up the Socket
        client_socket.settimeout(1)
        client_socket.sendto(str.encode("SV110"), address) #send command to arduino
        rec_data, addr = client_socket.recvfrom(1024)
        
        if rec_data==b'SV110_ok':
            _translate =  QCoreApplication.translate
            MainWindow.setWindowTitle(_translate("MainWindow", "MainWindow"))
            self.SV11.setText(_translate("MainWindow", "Closed"))
            color_effect = QGraphicsColorizeEffect() 
            color_effect.setColor(Qt.red) 
            self.SV11.setGraphicsEffect(color_effect)
            self.label_SV11.setText(_translate("MainWindow", "Closed"))
            color_effect = QGraphicsColorizeEffect() 
            color_effect.setColor(Qt.red) 
            self.label_SV11.setGraphicsEffect(color_effect)
    ...
    def SV121(self):
        ...
        client_socket = socket(AF_INET, SOCK_DGRAM) #Set Up the Socket
        client_socket.settimeout(1)
        client_socket.sendto(str.encode("SV121"), address) #send command to arduino
        rec_data, addr = client_socket.recvfrom(1024)
        
        if rec_data==b'SV121_ok':
            _translate =  QCoreApplication.translate
            MainWindow.setWindowTitle(_translate("MainWindow", "MainWindow"))
            self.SV12.setText(_translate("MainWindow", "Open"))
            color_effect = QGraphicsColorizeEffect() 
            color_effect.setColor(Qt.darkGreen) 
            self.SV12.setGraphicsEffect(color_effect)
            self.label_SV12.setText(_translate("MainWindow", "Open"))
            color_effect = QGraphicsColorizeEffect() 
            color_effect.setColor(Qt.darkGreen) 
            self.label_SV12.setGraphicsEffect(color_effect)
        
    def SV120(self):
        address = ('192.168.0.101', 5000) #Defind who you are talking to (must match arduino IP and port)
        client_socket = socket(AF_INET, SOCK_DGRAM) #Set Up the Socket
        client_socket.settimeout(1)
        client_socket.sendto(str.encode("SV120"), address) #send command to arduino
        rec_data, addr = client_socket.recvfrom(1024)
        if rec_data==b'SV120_ok':
            _translate =  QCoreApplication.translate
            MainWindow.setWindowTitle(_translate("MainWindow", "MainWindow"))
            self.SV12.setText(_translate("MainWindow", "Closed"))
            color_effect = QGraphicsColorizeEffect() 
    ...
    def SV211(self):
        ...
        client_socket = socket(AF_INET, SOCK_DGRAM) #Set Up the Socket
        client_socket.settimeout(1)
        client_socket.sendto(str.encode("SV211"), address) #send command to arduino
        rec_data, addr = client_socket.recvfrom(1024)
        if rec_data==b'SV211_ok':
            _translate =  QCoreApplication.translate
            MainWindow.setWindowTitle(_translate("MainWindow", "MainWindow"))
            self.SV21.setText(_translate("MainWindow", "Open"))
            color_effect = QGraphicsColorizeEffect() 
            color_effect.setColor(Qt.darkGreen) 
            self.SV21.setGraphicsEffect(color_effect)
            self.label_SV21.setText(_translate("MainWindow", "Open"))
            color_effect = QGraphicsColorizeEffect() 
            color_effect.setColor(Qt.darkGreen) 
            self.label_SV21.setGraphicsEffect(color_effect)
        
    def SV210(self):
        address = ('192.168.0.101', 5000) #Defind who you are talking to (must match arduino IP and port)
        client_socket = socket(AF_INET, SOCK_DGRAM) #Set Up the Socket
        client_socket.settimeout(1)
        client_socket.sendto(str.encode("SV210"), address) #send command to arduino
        rec_data, addr = client_socket.recvfrom(1024)
        if rec_data==b'SV210_ok':
            _translate =  QCoreApplication.translate
            MainWindow.setWindowTitle(_translate("MainWindow", "MainWindow"))
            self.SV21.setText(_translate("MainWindow", "Closed"))
            color_effect = QGraphicsColorizeEffect() 
            color_effect.setColor(Qt.red) 
            self.SV21.setGraphicsEffect(color_effect)
            self.label_SV21.setText(_translate("MainWindow", "Closed"))
            color_effect = QGraphicsColorizeEffect() 
            color_effect.setColor(Qt.red) 
            self.label_SV21.setGraphicsEffect(color_effect)
    ...
    def SV221(self):
        ...
        client_socket = socket(AF_INET, SOCK_DGRAM) #Set Up the Socket
        client_socket.settimeout(1)
        client_socket.sendto(str.encode("SV221"), address) #send command to arduino
        rec_data, addr = client_socket.recvfrom(1024)
        if rec_data==b'SV221_ok':
            _translate =  QCoreApplication.translate
            MainWindow.setWindowTitle(_translate("MainWindow", "MainWindow"))
            self.SV22.setText(_translate("MainWindow", "Open"))
            color_effect = QGraphicsColorizeEffect() 
            color_effect.setColor(Qt.darkGreen) 
            self.SV22.setGraphicsEffect(color_effect)
            self.label_SV22.setText(_translate("MainWindow", "Open"))
            color_effect = QGraphicsColorizeEffect() 
            color_effect.setColor(Qt.darkGreen) 
            self.label_SV22.setGraphicsEffect(color_effect)
        
    def SV220(self):
        address = ('192.168.0.101', 5000) #Defind who you are talking to (must match arduino IP and port)
        client_socket = socket(AF_INET, SOCK_DGRAM) #Set Up the Socket
        client_socket.settimeout(1)
        client_socket.sendto(str.encode("SV220"), address) #send command to arduino
        rec_data, addr = client_socket.recvfrom(1024)
        if rec_data==b'SV220_ok':
            _translate =  QCoreApplication.translate
            MainWindow.setWindowTitle(_translate("MainWindow", "MainWindow"))
            self.SV22.setText(_translate("MainWindow", "Closed"))
            color_effect = QGraphicsColorizeEffect() 
    ...
    def SV311(self):
        ...
        client_socket = socket(AF_INET, SOCK_DGRAM) #Set Up the Socket
        client_socket.settimeout(1)
        client_socket.sendto(str.encode("SV311"), address) #send command to arduino
        rec_data, addr = client_socket.recvfrom(1024)
        if rec_data==b'SV311_ok':
            _translate =  QCoreApplication.translate
            MainWindow.setWindowTitle(_translate("MainWindow", "MainWindow"))
            self.SV31.setText(_translate("MainWindow", "Open"))
            color_effect = QGraphicsColorizeEffect() 
            color_effect.setColor(Qt.darkGreen) 
            self.SV31.setGraphicsEffect(color_effect)
            self.label_SV31.setText(_translate("MainWindow", "Open"))
            color_effect = QGraphicsColorizeEffect() 
            color_effect.setColor(Qt.darkGreen) 
            self.label_SV31.setGraphicsEffect(color_effect)
        
    def SV310(self):
        address = ('192.168.0.101', 5000) #Defind who you are talking to (must match arduino IP and port)
        client_socket = socket(AF_INET, SOCK_DGRAM) #Set Up the Socket
        client_socket.settimeout(1)
        client_socket.sendto(str.encode("SV310"), address) #send command to arduino
        rec_data, addr = client_socket.recvfrom(1024)
        if rec_data==b'SV310_ok':
            _translate =  QCoreApplication.translate
            MainWindow.setWindowTitle(_translate("MainWindow", "MainWindow"))
            self.SV31.setText(_translate("MainWindow", "Closed"))
            color_effect = QGraphicsColorizeEffect() 
    ...
    def SV321(self):
        ...
        client_socket = socket(AF_INET, SOCK_DGRAM) #Set Up the Socket
        client_socket.settimeout(1)
        client_socket.sendto(str.encode("SV321"), address) #send command to arduino
        rec_data, addr = client_socket.recvfrom(1024)
        
        
        if rec_data==b'SV321_ok':
            _translate =  QCoreApplication.translate
            MainWindow.setWindowTitle(_translate("MainWindow", "MainWindow"))
            self.SV32.setText(_translate("MainWindow", "Open"))
            color_effect = QGraphicsColorizeEffect() 
            color_effect.setColor(Qt.darkGreen) 
            self.SV32.setGraphicsEffect(color_effect)
            self.label_SV32.setText(_translate("MainWindow", "Open"))
            color_effect = QGraphicsColorizeEffect() 
            color_effect.setColor(Qt.darkGreen) 
            self.label_SV32.setGraphicsEffect(color_effect)
        
    def SV320(self):
        address = ('192.168.0.101', 5000) #Defind who you are talking to (must match arduino IP and port)
        client_socket = socket(AF_INET, SOCK_DGRAM) #Set Up the Socket
        client_socket.settimeout(1)
        client_socket.sendto(str.encode("SV320"), address) #send command to arduino
        rec_data, addr = client_socket.recvfrom(1024)
        if rec_data==b'SV320_ok':
            _translate =  QCoreApplication.translate
            MainWindow.setWindowTitle(_translate("MainWindow", "MainWindow"))
            self.SV32.setText(_translate("MainWindow", "Closed"))
            color_effect = QGraphicsColorizeEffect() 
    ...
    def SV331(self):
        ...
        client_socket = socket(AF_INET, SOCK_DGRAM) #Set Up the Socket
        client_socket.settimeout(1)
        client_socket.sendto(str.encode("SV331"), address) #send command to arduino
        rec_data, addr = client_socket.recvfrom(1024)
        if rec_data==b'SV331_ok':
            _translate =  QCoreApplication.translate
            MainWindow.setWindowTitle(_translate("MainWindow", "MainWindow"))
            self.SV33.setText(_translate("MainWindow", "Open"))
            color_effect = QGraphicsColorizeEffect() 
            color_effect.setColor(Qt.darkGreen) 
            self.SV33.setGraphicsEffect(color_effect)
            self.label_SV33.setText(_translate("MainWindow", "Open"))
            color_effect = QGraphicsColorizeEffect() 
            color_effect.setColor(Qt.darkGreen) 
            self.label_SV33.setGraphicsEffect(color_effect)
        
    def SV330(self):
        address = ('192.168.0.101', 5000) #Defind who you are talking to (must match arduino IP and port)
        client_socket = socket(AF_INET, SOCK_DGRAM) #Set Up the Socket
        client_socket.settimeout(1)
        client_socket.sendto(str.encode("SV330"), address) #send command to arduino
        rec_data, addr = client_socket.recvfrom(1024)
        if rec_data==b'SV330_ok':
            _translate =  QCoreApplication.translate
            MainWindow.setWindowTitle(_translate("MainWindow", "MainWindow"))
            self.SV33.setText(_translate("MainWindow", "Closed"))
            color_effect = QGraphicsColorizeEffect() 
    ...
    def SV341(self):
        ...
        client_socket = socket(AF_INET, SOCK_DGRAM) #Set Up the Socket
        client_socket.settimeout(1)
        client_socket.sendto(str.encode("SV341"), address) #send command to arduino
        rec_data, addr = client_socket.recvfrom(1024)
        if rec_data==b'SV341_ok':
            _translate =  QCoreApplication.translate
            MainWindow.setWindowTitle(_translate("MainWindow", "MainWindow"))
            self.SV34.setText(_translate("MainWindow", "Open"))
            color_effect = QGraphicsColorizeEffect() 
            color_effect.setColor(Qt.darkGreen) 
            self.SV34.setGraphicsEffect(color_effect)
            self.label_SV34.setText(_translate("MainWindow", "Open"))
            color_effect = QGraphicsColorizeEffect() 
            color_effect.setColor(Qt.darkGreen) 
            self.label_SV34.setGraphicsEffect(color_effect)
        
    def SV340(self):
        address = ('192.168.0.101', 5000) #Defind who you are talking to (must match arduino IP and port)
        client_socket = socket(AF_INET, SOCK_DGRAM) #Set Up the Socket
        client_socket.settimeout(1)
        client_socket.sendto(str.encode("SV340"), address) #send command to arduino
        rec_data, addr = client_socket.recvfrom(1024)
        if rec_data==b'SV340_ok':
            _translate =  QCoreApplication.translate
            MainWindow.setWindowTitle(_translate("MainWindow", "MainWindow"))
            self.SV34.setText(_translate("MainWindow", "Closed"))
            color_effect = QGraphicsColorizeEffect() 
    ...
    def SV351(self):
        ...
        client_socket = socket(AF_INET, SOCK_DGRAM) #Set Up the Socket
        client_socket.settimeout(1)
        client_socket.sendto(str.encode("SV351"), address) #send command to arduino
        rec_data, addr = client_socket.recvfrom(1024)
        if rec_data==b'SV351_ok':
            _translate =  QCoreApplication.translate
            MainWindow.setWindowTitle(_translate("MainWindow", "MainWindow"))
            self.SV35.setText(_translate("MainWindow", "Open"))
            color_effect = QGraphicsColorizeEffect() 
            color_effect.setColor(Qt.darkGreen) 
            self.SV35.setGraphicsEffect(color_effect)
            self.label_SV35.setText(_translate("MainWindow", "Open"))
            color_effect = QGraphicsColorizeEffect() 
            color_effect.setColor(Qt.darkGreen) 
            self.label_SV35.setGraphicsEffect(color_effect)
        
    def SV350(self):
        address = ('192.168.0.101', 5000) #Defind who you are talking to (must match arduino IP and port)
        client_socket = socket(AF_INET, SOCK_DGRAM) #Set Up the Socket
        client_socket.settimeout(1)
        client_socket.sendto(str.encode("SV350"), address) #send command to arduino
        rec_data, addr = client_socket.recvfrom(1024)
        if rec_data==b'SV350_ok':
            _translate =  QCoreApplication.translate
            MainWindow.setWindowTitle(_translate("MainWindow", "MainWindow"))
            self.SV35.setText(_translate("MainWindow", "Closed"))
            color_effect = QGraphicsColorizeEffect() 
    ...
    def SV511(self):
        ...
        client_socket = socket(AF_INET, SOCK_DGRAM) #Set Up the Socket
        client_socket.settimeout(1)
        client_socket.sendto(str.encode("SV511"), address) #send command to arduino
        rec_data, addr = client_socket.recvfrom(1024)
        if rec_data==b'SV511_ok':
            _translate =  QCoreApplication.translate
            MainWindow.setWindowTitle(_translate("MainWindow", "MainWindow"))
            self.SV51.setText(_translate("MainWindow", "Open"))
            color_effect = QGraphicsColorizeEffect() 
            color_effect.setColor(Qt.darkGreen) 
            self.SV51.setGraphicsEffect(color_effect)
            self.label_SV51.setText(_translate("MainWindow", "Open"))
            color_effect = QGraphicsColorizeEffect() 
            color_effect.setColor(Qt.darkGreen) 
            self.label_SV51.setGraphicsEffect(color_effect)
        
    def SV510(self):
        address = ('192.168.0.101', 5000) #Defind who you are talking to (must match arduino IP and port)
        client_socket = socket(AF_INET, SOCK_DGRAM) #Set Up the Socket
        client_socket.settimeout(1)
        client_socket.sendto(str.encode("SV510"), address) #send command to arduino
        rec_data, addr = client_socket.recvfrom(1024)
        if rec_data==b'SV510_ok':
            _translate =  QCoreApplication.translate
            MainWindow.setWindowTitle(_translate("MainWindow", "MainWindow"))
            self.SV51.setText(_translate("MainWindow", "Closed"))
            color_effect = QGraphicsColorizeEffect() 
    ...
    def SV611(self):
        ...
        client_socket = socket(AF_INET, SOCK_DGRAM) #Set Up the Socket
        client_socket.settimeout(1)
        client_socket.sendto(str.encode("SV611"), address) #send command to arduino
        rec_data, addr = client_socket.recvfrom(1024)
        if rec_data==b'SV611_ok':
            _translate =  QCoreApplication.translate
            MainWindow.setWindowTitle(_translate("MainWindow", "MainWindow"))
            self.SV61.setText(_translate("MainWindow", "Open"))
            color_effect = QGraphicsColorizeEffect() 
            color_effect.setColor(Qt.darkGreen) 
            self.SV61.setGraphicsEffect(color_effect)
            self.label_SV61.setText(_translate("MainWindow", "Open"))
            color_effect = QGraphicsColorizeEffect() 
            color_effect.setColor(Qt.darkGreen) 
            self.label_SV61.setGraphicsEffect(color_effect)
        
    def SV610(self):
        address = ('192.168.0.101', 5000) #Defind who you are talking to (must match arduino IP and port)
        client_socket = socket(AF_INET, SOCK_DGRAM) #Set Up the Socket
        client_socket.settimeout(1)
        client_socket.sendto(str.encode("SV610"), address) #send command to arduino
        rec_data, addr = client_socket.recvfrom(1024)
        if rec_data==b'SV610_ok':
            _translate =  QCoreApplication.translate
            MainWindow.setWindowTitle(_translate("MainWindow", "MainWindow"))
            self.SV61.setText(_translate("MainWindow", "Closed"))
            color_effect = QGraphicsColorizeEffect() 
    ...
    def SV621(self):
        ...
        client_socket = socket(AF_INET, SOCK_DGRAM) #Set Up the Socket
        client_socket.settimeout(1)
        client_socket.sendto(str.encode("SV621"), address) #send command to arduino
        rec_data, addr = client_socket.recvfrom(1024)
        if rec_data==b'SV621_ok':
            _translate =  QCoreApplication.translate
            MainWindow.setWindowTitle(_translate("MainWindow", "MainWindow"))
            self.SV62.setText(_translate("MainWindow", "Open"))
            color_effect = QGraphicsColorizeEffect() 
            color_effect.setColor(Qt.darkGreen) 
            self.SV62.setGraphicsEffect(color_effect)
            self.label_SV62.setText(_translate("MainWindow", "Open"))
            color_effect = QGraphicsColorizeEffect() 
            color_effect.setColor(Qt.darkGreen) 
            self.label_SV62.setGraphicsEffect(color_effect)
        
    def SV620(self):
        address = ('192.168.0.101', 5000) #Defind who you are talking to (must match arduino IP and port)
        client_socket = socket(AF_INET, SOCK_DGRAM) #Set Up the Socket
        client_socket.settimeout(1)
        client_socket.sendto(str.encode("SV620"), address) #send command to arduino
        rec_data, addr = client_socket.recvfrom(1024)
        if rec_data==b'SV620_ok':
            _translate =  QCoreApplication.translate
            MainWindow.setWindowTitle(_translate("MainWindow", "MainWindow"))
            self.SV62.setText(_translate("MainWindow", "Closed"))
            color_effect = QGraphicsColorizeEffect() 
