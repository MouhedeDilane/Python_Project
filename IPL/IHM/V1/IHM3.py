...
class MultiRealTimePlot(QMainWindow):
    ...
    def update_plots(self):
        self.RealTimePlot1=RealTimePlot1()
        self.RealTimePlot2=RealTimePlot2()
        self.RealTimePlot3=RealTimePlot3()
        self.RealTimePlot1.update_plot(Figure(figsize=(18,6)))
        self.RealTimePlot2.update_plot(Figure(figsize=(18,6)))
        self.RealTimePlot3.update_plot(Figure(figsize=(18,6)))
