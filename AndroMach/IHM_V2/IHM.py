...
multi_csv=1 # 1-->unique csv / 0-->default csv
    ...
    def update_str(self,values):
        ...
        for i in range(0,7):
            if i==0 or i==1 or i==2:
                ...
                self.sensors[i].setText(_translate("MainWindow", str(val[i]/1000)+"kg/s"))
...
""")
    ...
    def update_plot(self):
        ...
        if self.checkbox_6.isChecked():
            self.ax3.plot(self.x_data, [data[5]/1000 for data in self.y_data],color='blue', label="FS1")
        ...
        if self.checkbox_7.isChecked():
            self.ax3.plot(self.x_data, [data[6]/1000 for data in self.y_data],color='orange', label="FS2")
